...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BTNSimuladorM.setBackground(new java.awt.Color(0, 0, 0));
        BTNSimuladorM.setForeground(new java.awt.Color(255, 255, 255));
        BTNSimuladorM.setText("SIMULADOR DE MARCAS");
        BTNSimuladorM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BTNSimuladorMActionPerformed(evt);
            }
        });
