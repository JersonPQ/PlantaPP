 ...
 * @author XPC
 */
public class LoginCPlanilla extends javax.swing.JFrame {

    /**
     * Creates new form Marcas
     */
    public LoginCPlanilla() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TxtFieldCEmpleado.setText("jTextField1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginCPlanilla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginCPlanilla().setVisible(true);
            }
        });
    }
